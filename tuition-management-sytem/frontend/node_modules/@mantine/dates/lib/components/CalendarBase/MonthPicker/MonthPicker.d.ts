...
export declare function MonthPicker({ className, styles, classNames, value, onChange, locale, year, onYearChange, onNextLevel, size, minDate, maxDate, __staticSelector, nextYearLabel, previousYearLabel, preventFocus, unstyled, yearLabelFormat, __stopPropagation, ...others }: MonthPickerProps): JSX.Element;
