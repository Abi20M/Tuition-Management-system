...
export declare function YearPicker({ className, styles, classNames, value, onChange, size, minYear, maxYear, __staticSelector, nextDecadeLabel, previousDecadeLabel, preventFocus, unstyled, yearLabelFormat, __stopPropagation, ...others }: YearPickerProps): JSX.Element;
