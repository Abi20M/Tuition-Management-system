...
function getDayProps({
  ...
  const selected = hasValue && (Array.isArray(value) ? value.some((val) => isSameDate.isSameDate(val, date)) : isSameDate.isSameDate(date, value));
  ...
  return {
    ...
    weekend: isWeekend.isWeekend(date, weekendDays),
    selectedInRange,
    selected,
    inRange,
    firstInRange,
