...
// import TeacherDrawer  from "../teacherProfileDrawer";
...
// export const TeacherHeaderLogin = ({ user }: HeaderProps) => {
...
//   const [sidePanelOpened,setSidePanelOpened] = useState(false);//use to open and close the side pannel of the teacher details
...
//       size="xl"
//     >
//       <TeacherDrawer sidePannel={setSidePanelOpened} teacherDetails = {user}/>
//     </Drawer>
//     </div>
//   );
// };

// //export default TeacherHeaderLogin;