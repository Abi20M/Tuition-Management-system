...
//generating PDF
export const StudentPDF = ({ data, user, parent }: any) => {
    ...
    return (
        ...
        <>
            <Document>
                <Page size="A2" orientation="landscape">
                        ...
                        <Fragment>
                            <View style={styles.table}>
                                <View style={styles.tableRow}>
                                    <View style={{
                                        width: "5%", backgroundColor: "#eff5f5",
                                        borderStyle: "solid",
                                        borderWidth: 1,
                                        borderLeftWidth: 0,
                                        borderTopWidth: 0,
                                    ...
                                    <View style={{
                                        width: "12%", backgroundColor: "#eff5f5",
                                        borderStyle: "solid",
                                        borderWidth: 1,
                                        borderLeftWidth: 0,
                                        borderTopWidth: 0,
                                    ...
                                    <View style={styles.HeaderCol}>
                                        <Text style={styles.headerFont}>School</Text>
                                    </View>
                                    <View style={{
                                        width: "3%", backgroundColor: "#eff5f5",
                                        borderStyle: "solid",
                                        borderWidth: 1,
                                        borderLeftWidth: 0,
                                        borderTopWidth: 0,
                                    }}>
                                        <Text style={styles.headerFont}>Grade</Text>
                                    </View>
                                    <View style={styles.HeaderCol}>
                                    ...
                                    <View style={{
                                        width: "20%", backgroundColor: "#eff5f5",
                                        borderStyle: "solid",
                                        borderWidth: 1,
                                        borderLeftWidth: 0,
                                        borderTopWidth: 0,
                                    ...
                                    <View style={styles.HeaderCol}>
                                        <Text style={styles.headerFont}>Parent</Text>
                                    </View>
                                </View>
                                ...
                                {data !== null
                                    ? data.map((data: any, i: any) => (
                                        <View key={i} style={styles.tableRow}>
                                            ...
                                            <View style={styles.tableCol}>
                                                <Text style={styles.tableCell}>{data.birthDate.slice(0, 10)}</Text>
                                            </View>
                                            <View style={styles.tableCol}>
                                                <Text style={styles.tableCell}>{data.gender}</Text>
                                            </View>
                                            <View style={{
                                                width: "20%", borderStyle: "solid",
                                                borderWidth: 1,
                                                borderLeftWidth: 0,
                                                borderTopWidth: 0,
                                            }}>
                                            ...
                                            <View style={styles.tableCol}>
                                                <Text style={styles.tableCell}>{parent.map((parentDetails: {
                                                    _id: string,
                                                    id: string;
                                                    name: string;
                                                    email: string;
                                                    ...
                                                    if (parentDetails._id === data.parent) {
